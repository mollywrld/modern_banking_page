...
import { discount, robot } from '../assests/assets'
  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div>
        ...
        <div className='absolute z-[0] w-[40%] h-[20%] top-0 rounded-full pink__gradient'/>
        <div className='absolute z-[1] w-[80%] h-[40%] bottom-40 white__gradient'/>
